...
secure(".secureName", "keyup blur focus", nameExp, "Entrez 2 à 20 caractères sans utilisé de caractères speciaux");
secure(".mailSecure", "keyup blur focus", emailExp, "Adresse Email non valide");
secure(".passSecure", "blur", passExp, "Entrez au moins 6 caractère avec au moins une Majuscule et un chiffre");
